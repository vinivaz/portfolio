 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e($,Y){var Z=$.length;$.push(Y);e:for(;0<Z;){var Ae=Z-1>>>1,fe=$[Ae];if(0<i(fe,Y))$[Ae]=Y,$[Z]=fe,Z=Ae;else break e}}function n($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var Y=$[0],Z=$.pop();if(Z!==Y){$[0]=Z;e:for(var Ae=0,fe=$.length,Le=fe>>>1;Ae<Le;){var zn=2*(Ae+1)-1,$n=$[zn],Wn=zn+1,Hn=$[Wn];if(0>i($n,Z))Wn<fe&&0>i(Hn,$n)?($[Ae]=Hn,$[Wn]=Z,Ae=Wn):($[Ae]=$n,$[zn]=Z,Ae=zn);else if(Wn<fe&&0>i(Hn,Z))$[Ae]=Hn,$[Wn]=Z,Ae=Wn;else break e}}return Y}function i($,Y){var Z=$.sortIndex-Y.sortIndex;return Z!==0?Z:$.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var u=[],c=[],h=1,f=null,m=3,y=!1,v=!1,P=!1,N=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,E=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S($){for(var Y=n(c);Y!==null;){if(Y.callback===null)r(c);else if(Y.startTime<=$)r(c),Y.sortIndex=Y.expirationTime,e(u,Y);else break;Y=n(c)}}function D($){if(P=!1,S($),!v)if(n(u)!==null)v=!0,Rn(M);else{var Y=n(c);Y!==null&&Bn(D,Y.startTime-$)}}function M($,Y){v=!1,P&&(P=!1,I(_),_=-1),y=!0;var Z=m;try{for(S(Y),f=n(u);f!==null&&(!(f.expirationTime>Y)||$&&!T());){var Ae=f.callback;if(typeof Ae=="function"){f.callback=null,m=f.priorityLevel;var fe=Ae(f.expirationTime<=Y);Y=t.unstable_now(),typeof fe=="function"?f.callback=fe:f===n(u)&&r(u),S(Y)}else r(u);f=n(u)}if(f!==null)var Le=!0;else{var zn=n(c);zn!==null&&Bn(D,zn.startTime-Y),Le=!1}return Le}finally{f=null,m=Z,y=!1}}var U=!1,C=null,_=-1,A=5,k=-1;function T(){return!(t.unstable_now()-k<A)}function x(){if(C!==null){var $=t.unstable_now();k=$;var Y=!0;try{Y=C(!0,$)}finally{Y?R():(U=!1,C=null)}}else U=!1}var R;if(typeof E=="function")R=function(){E(x)};else if(typeof MessageChannel<"u"){var ye=new MessageChannel,Nt=ye.port2;ye.port1.onmessage=x,R=function(){Nt.postMessage(null)}}else R=function(){N(x,0)};function Rn($){C=$,U||(U=!0,R())}function Bn($,Y){_=N(function(){$(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function($){$.callback=null},t.unstable_continueExecution=function(){v||y||(v=!0,Rn(M))},t.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<$?Math.floor(1e3/$):5},t.unstable_getCurrentPriorityLevel=function(){return m},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function($){switch(m){case 1:case 2:case 3:var Y=3;break;default:Y=m}var Z=m;m=Y;try{return $()}finally{m=Z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function($,Y){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var Z=m;m=$;try{return Y()}finally{m=Z}},t.unstable_scheduleCallback=function($,Y,Z){var Ae=t.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?Ae+Z:Ae):Z=Ae,$){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=Z+fe,$={id:h++,callback:Y,priorityLevel:$,startTime:Z,expirationTime:fe,sortIndex:-1},Z>Ae?($.sortIndex=Z,e(c,$),n(u)===null&&$===n(c)&&(P?(I(_),_=-1):P=!0,Bn(D,Z-Ae))):($.sortIndex=fe,e(u,$),v||y||(v=!0,Rn(M))),$},t.unstable_shouldYield=T,t.unstable_wrapCallback=function($){var Y=m;return function(){var Z=m;m=Y;try{return $.apply(this,arguments)}finally{m=Z}}}})(F0);U0.exports=F0;var Ik=U0.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function Ya(){return Ya=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},Ya.apply(this,arguments)}const ag=j.createContext(null),ZN=j.createContext(null),gl=j.createContext(null),vh=j.createContext(null),Ji=j.createContext({outlet:null,matches:[],isDataRoute:!1}),qI=j.createContext(null);function _l(){return j.useContext(vh)!=null}function lg(){return _l()||Be(!1),j.useContext(vh).location}function KI(t){j.useContext(gl).static||j.useLayoutEffect(t)}function ex(){let{isDataRoute:t}=j.useContext(Ji);return t?fx():tx()}function tx(){_l()||Be(!1);let t=j.useContext(ag),{basename:e,future:n,navigator:r}=j.useContext(gl),{matches:i}=j.useContext(Ji),{pathname:s}=lg(),o=JSON.stringify($I(i,n.v7_relativeSplatPath)),a=j.useRef(!1);return KI(()=>{a.current=!0}),j.useCallback(function(c,h){if(h===void 0&&(h={}),!a.current)return;if(typeof c=="number"){r.go(c);return}let f=WI(c,JSON.parse(o),s,h.relative==="path");t==null&&e!=="/"&&(f.pathname=f.pathname==="/"?e:Pi([e,f.pathname])),(h.replace?r.replace:r.push)(f,h.state,h)},[e,r,o,s,t])}function nx(t,e){return rx(t,e)}function rx(t,e,n,r){_l()||Be(!1);let{navigator:i}=j.useContext(gl),{matches:s}=j.useContext(Ji),o=s[s.length-1],a=o?o.params:{};o&&o.pathname;let u=o?o.pathnameBase:"/";o&&o.route;let c=lg(),h;if(e){var f;let N=typeof e=="string"?mo(e):e;u==="/"||(f=N.pathname)!=null&&f.startsWith(u)||Be(!1),h=N}else h=c;let m=h.pathname||"/",y=m;if(u!=="/"){let N=u.replace(/^\//,"").split("/");y="/"+m.replace(/^\//,"").split("/").slice(N.length).join("/")}let v=xN(t,{pathname:y}),P=lx(v&&v.map(N=>Object.assign({},N,{params:Object.assign({},a,N.params),pathname:Pi([u,i.encodeLocation?i.encodeLocation(N.pathname).pathname:N.pathname]),pathnameBase:N.pathnameBase==="/"?u:Pi([u,i.encodeLocation?i.encodeLocation(N.pathnameBase).pathname:N.pathnameBase])})),s,n,r);return e&&P?j.createElement(vh.Provider,{value:{location:Ya({pathname:"/",search:"",hash:"",state:null,key:"default"},h),navigationType:Lr.Pop}},P):P}function ix(){let t=dx(),e=XN(t)?t.status+" "+t.statusText:t instanceof Error?t.message:JSON.stringify(t),n=t instanceof Error?t.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return j.createElement(j.Fragment,null,j.createElement("h2",null,"Unexpected Application Error!"),j.createElement("h3",{style:{fontStyle:"italic"}},e),n?j.createElement("pre",{style:i},n):null,null)}const sx=j.createElement(ix,null);class ox extends j.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,n){return n.location!==e.location||n.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:n.error,location:n.location,revalidation:e.revalidation||n.revalidation}}componentDidCatch(e,n){console.error("React Router caught the following error during render",e,n)}render(){return this.state.error!==void 0?j.createElement(Ji.Provider,{value:this.props.routeContext},j.createElement(qI.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function ax(t){let{routeContext:e,match:n,children:r}=t,i=j.useContext(ag);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),j.createElement(Ji.Provider,{value:e},r)}function lx(t,e,n,r){var i;if(e===void 0&&(e=[]),n===void 0&&(n=null),r===void 0&&(r=null),t==null){var s;if(!n)return null;if(n.errors)t=n.matches;else if((s=r)!=null&&s.v7_partialHydration&&e.length===0&&!n.initialized&&n.matches.length>0)t=n.matches;else return null}let o=t,a=(i=n)==null?void 0:i.errors;if(a!=null){let h=o.findIndex(f=>f.route.id&&(a==null?void 0:a[f.route.id])!==void 0);h>=0||Be(!1),o=o.slice(0,Math.min(o.length,h+1))}let u=!1,c=-1;if(n&&r&&r.v7_partialHydration)for(let h=0;h<o.length;h++){let f=o[h];if((f.route.HydrateFallback||f.route.hydrateFallbackElement)&&(c=h),f.route.id){let{loaderData:m,errors:y}=n,v=f.route.loader&&m[f.route.id]===void 0&&(!y||y[f.route.id]===void 0);if(f.route.lazy||v){u=!0,c>=0?o=o.slice(0,c+1):o=[o[0]];break}}}return o.reduceRight((h,f,m)=>{let y,v=!1,P=null,N=null;n&&(y=a&&f.route.id?a[f.route.id]:void 0,P=f.route.errorElement||sx,u&&(c<0&&m===0?(v=!0,N=null):c===m&&(v=!0,N=f.route.hydrateFallbackElement||null)));let I=e.concat(o.slice(0,m+1)),E=()=>{let S;return y?S=P:v?S=N:f.route.Component?S=j.createElement(f.route.Component,null):f.route.element?S=f.route.element:S=h,j.createElement(ax,{match:f,routeContext:{outlet:h,matches:I,isDataRoute:n!=null},children:S})};return n&&(f.route.ErrorBoundary||f.route.errorElement||m===0)?j.createElement(ox,{location:n.location,revalidation:n.revalidation,component:P,error:y,children:E(),routeContext:{outlet:null,matches:I,isDataRoute:!0}}):E()},null)}var GI=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(GI||{}),Cc=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(Cc||{});function ux(t){let e=j.useContext(ag);return e||Be(!1),e}function cx(t){let e=j.useContext(ZN);return e||Be(!1),e}function hx(t){let e=j.useContext(Ji);return e||Be(!1),e}function QI(t){let e=hx(),n=e.matches[e.matches.length-1];return n.route.id||Be(!1),n.route.id}function dx(){var t;let e=j.useContext(qI),n=cx(Cc.UseRouteError),r=QI(Cc.UseRouteError);return e!==void 0?e:(t=n.errors)==null?void 0:t[r]}function fx(){let{router:t}=ux(GI.UseNavigateStable),e=QI(Cc.UseNavigateStable),n=j.useRef(!1);return KI(()=>{n.current=!0}),j.useCallback(function(i,s){s===void 0&&(s={}),n.current&&(typeof i=="number"?t.navigate(i):t.navigate(i,Ya({fromRouteId:e},s)))},[t,e])}function px(t){let{to:e,replace:n,state:r,relative:i}=t;_l()||Be(!1);let{future:s,static:o}=j.useContext(gl),{matches:a}=j.useContext(Ji),{pathname:u}=lg(),c=ex(),h=WI(e,$I(a,s.v7_relativeSplatPath),u,i==="path"),f=JSON.stringify(h);return j.useEffect(()=>c(JSON.parse(f),{replace:n,state:r,relative:i}),[c,f,i,n,r]),null}function $u(t){Be(!1)}function mx(t){let{basename:e="/",children:n=null,location:r,navigationType:i=Lr.Pop,navigator:s,static:o=!1,future:a}=t;_l()&&Be(!1);let u=e.replace(/^\/*/,"/"),c=j.useMemo(()=>({basename:u,navigator:s,static:o,future:Ya({v7_relativeSplatPath:!1},a)}),[u,a,s,o]);typeof r=="string"&&(r=mo(r));let{pathname:h="/",search:f="",hash:m="",state:y=null,key:v="default"}=r,P=j.useMemo(()=>{let N=zI(h,u);return N==null?null:{location:{pathname:N,search:f,hash:m,state:y,key:v},navigationType:i}},[u,h,f,m,y,v,i]);return P==null?null:j.createElement(gl.Provider,{value:c},j.createElement(vh.Provider,{children:n,value:P}))}function gx(t){let{children:e,location:n}=t;return nx(yp(e),n)}new Promise(()=>{});function yp(t,e){e===void 0&&(e=[]);let n=[];return j.Children.forEach(t,(r,i)=>{if(!j.isValidElement(r))return;let s=[...e,i];if(r.type===j.Fragment){n.push.apply(n,yp(r.props.children,s));return}r.type!==$u&&Be(!1),!r.props.index||!r.props.children||Be(!1);let o={id:r.props.id||s.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(o.children=yp(r.props.children,s)),n.push(o)}),n}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gb(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Qb(t){const e=aa(la(t)).link,n=e?aa(la(e)).deep_link_id:null,r=aa(la(t)).deep_link_id;return(r?aa(la(r)).link:null)||r||n||e||t}class Sg{constructor(e){var n,r,i,s,o,a;const u=aa(la(e)),c=(n=u.apiKey)!==null&&n!==void 0?n:null,h=(r=u.oobCode)!==null&&r!==void 0?r:null,f=Gb((i=u.mode)!==null&&i!==void 0?i:null);G(c&&h&&f,"argument-error"),this.apiKey=c,this.operation=f,this.code=h,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=u.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=Qb(e);try{return new Sg(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oM="__/auth/handler",aM="emulator/auth/handler",lM=encodeURIComponent("fac");async function jw(t,e,n,r,i,s){G(t.config.authDomain,t,"auth-domain-config-required"),G(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:li,eventId:i};if(e instanceof JS){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Rp(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[h,f]of Object.entries({}))o[h]=f}if(e instanceof Il){const h=e.getScopes().filter(f=>f!=="");h.length>0&&(o.scopes=h.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const h of Object.keys(a))a[h]===void 0&&delete a[h];const u=await t._getAppCheckToken(),c=u?`#${lM}=${encodeURIComponent(u)}`:"";return`${uM(t)}?${_o(a).slice(1)}${c}`}function uM({config:t}){return t.emulator?wg(t,aM):`https://${t.authDomain}/${oM}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Ni,dC;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(C,_){function A(){}A.prototype=_.prototype,C.D=_.prototype,C.prototype=new A,C.prototype.constructor=C,C.C=function(k,T,x){for(var R=Array(arguments.length-2),ye=2;ye<arguments.length;ye++)R[ye-2]=arguments[ye];return _.prototype[T].apply(k,R)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(C,_,A){A||(A=0);var k=Array(16);if(typeof _=="string")for(var T=0;16>T;++T)k[T]=_.charCodeAt(A++)|_.charCodeAt(A++)<<8|_.charCodeAt(A++)<<16|_.charCodeAt(A++)<<24;else for(T=0;16>T;++T)k[T]=_[A++]|_[A++]<<8|_[A++]<<16|_[A++]<<24;_=C.g[0],A=C.g[1],T=C.g[2];var x=C.g[3],R=_+(x^A&(T^x))+k[0]+3614090360&4294967295;_=A+(R<<7&4294967295|R>>>25),R=x+(T^_&(A^T))+k[1]+3905402710&4294967295,x=_+(R<<12&4294967295|R>>>20),R=T+(A^x&(_^A))+k[2]+606105819&4294967295,T=x+(R<<17&4294967295|R>>>15),R=A+(_^T&(x^_))+k[3]+3250441966&4294967295,A=T+(R<<22&4294967295|R>>>10),R=_+(x^A&(T^x))+k[4]+4118548399&4294967295,_=A+(R<<7&4294967295|R>>>25),R=x+(T^_&(A^T))+k[5]+1200080426&4294967295,x=_+(R<<12&4294967295|R>>>20),R=T+(A^x&(_^A))+k[6]+2821735955&4294967295,T=x+(R<<17&4294967295|R>>>15),R=A+(_^T&(x^_))+k[7]+4249261313&4294967295,A=T+(R<<22&4294967295|R>>>10),R=_+(x^A&(T^x))+k[8]+1770035416&4294967295,_=A+(R<<7&4294967295|R>>>25),R=x+(T^_&(A^T))+k[9]+2336552879&4294967295,x=_+(R<<12&4294967295|R>>>20),R=T+(A^x&(_^A))+k[10]+4294925233&4294967295,T=x+(R<<17&4294967295|R>>>15),R=A+(_^T&(x^_))+k[11]+2304563134&4294967295,A=T+(R<<22&4294967295|R>>>10),R=_+(x^A&(T^x))+k[12]+1804603682&4294967295,_=A+(R<<7&4294967295|R>>>25),R=x+(T^_&(A^T))+k[13]+4254626195&4294967295,x=_+(R<<12&4294967295|R>>>20),R=T+(A^x&(_^A))+k[14]+2792965006&4294967295,T=x+(R<<17&4294967295|R>>>15),R=A+(_^T&(x^_))+k[15]+1236535329&4294967295,A=T+(R<<22&4294967295|R>>>10),R=_+(T^x&(A^T))+k[1]+4129170786&4294967295,_=A+(R<<5&4294967295|R>>>27),R=x+(A^T&(_^A))+k[6]+3225465664&4294967295,x=_+(R<<9&4294967295|R>>>23),R=T+(_^A&(x^_))+k[11]+643717713&4294967295,T=x+(R<<14&4294967295|R>>>18),R=A+(x^_&(T^x))+k[0]+3921069994&4294967295,A=T+(R<<20&4294967295|R>>>12),R=_+(T^x&(A^T))+k[5]+3593408605&4294967295,_=A+(R<<5&4294967295|R>>>27),R=x+(A^T&(_^A))+k[10]+38016083&4294967295,x=_+(R<<9&4294967295|R>>>23),R=T+(_^A&(x^_))+k[15]+3634488961&4294967295,T=x+(R<<14&4294967295|R>>>18),R=A+(x^_&(T^x))+k[4]+3889429448&4294967295,A=T+(R<<20&4294967295|R>>>12),R=_+(T^x&(A^T))+k[9]+568446438&4294967295,_=A+(R<<5&4294967295|R>>>27),R=x+(A^T&(_^A))+k[14]+3275163606&4294967295,x=_+(R<<9&4294967295|R>>>23),R=T+(_^A&(x^_))+k[3]+4107603335&4294967295,T=x+(R<<14&4294967295|R>>>18),R=A+(x^_&(T^x))+k[8]+1163531501&4294967295,A=T+(R<<20&4294967295|R>>>12),R=_+(T^x&(A^T))+k[13]+2850285829&4294967295,_=A+(R<<5&4294967295|R>>>27),R=x+(A^T&(_^A))+k[2]+4243563512&4294967295,x=_+(R<<9&4294967295|R>>>23),R=T+(_^A&(x^_))+k[7]+1735328473&4294967295,T=x+(R<<14&4294967295|R>>>18),R=A+(x^_&(T^x))+k[12]+2368359562&4294967295,A=T+(R<<20&4294967295|R>>>12),R=_+(A^T^x)+k[5]+4294588738&4294967295,_=A+(R<<4&4294967295|R>>>28),R=x+(_^A^T)+k[8]+2272392833&4294967295,x=_+(R<<11&4294967295|R>>>21),R=T+(x^_^A)+k[11]+1839030562&4294967295,T=x+(R<<16&4294967295|R>>>16),R=A+(T^x^_)+k[14]+4259657740&4294967295,A=T+(R<<23&4294967295|R>>>9),R=_+(A^T^x)+k[1]+2763975236&4294967295,_=A+(R<<4&4294967295|R>>>28),R=x+(_^A^T)+k[4]+1272893353&4294967295,x=_+(R<<11&4294967295|R>>>21),R=T+(x^_^A)+k[7]+4139469664&4294967295,T=x+(R<<16&4294967295|R>>>16),R=A+(T^x^_)+k[10]+3200236656&4294967295,A=T+(R<<23&4294967295|R>>>9),R=_+(A^T^x)+k[13]+681279174&4294967295,_=A+(R<<4&4294967295|R>>>28),R=x+(_^A^T)+k[0]+3936430074&4294967295,x=_+(R<<11&4294967295|R>>>21),R=T+(x^_^A)+k[3]+3572445317&4294967295,T=x+(R<<16&4294967295|R>>>16),R=A+(T^x^_)+k[6]+76029189&4294967295,A=T+(R<<23&4294967295|R>>>9),R=_+(A^T^x)+k[9]+3654602809&4294967295,_=A+(R<<4&4294967295|R>>>28),R=x+(_^A^T)+k[12]+3873151461&4294967295,x=_+(R<<11&4294967295|R>>>21),R=T+(x^_^A)+k[15]+530742520&4294967295,T=x+(R<<16&4294967295|R>>>16),R=A+(T^x^_)+k[2]+3299628645&4294967295,A=T+(R<<23&4294967295|R>>>9),R=_+(T^(A|~x))+k[0]+4096336452&4294967295,_=A+(R<<6&4294967295|R>>>26),R=x+(A^(_|~T))+k[7]+1126891415&4294967295,x=_+(R<<10&4294967295|R>>>22),R=T+(_^(x|~A))+k[14]+2878612391&4294967295,T=x+(R<<15&4294967295|R>>>17),R=A+(x^(T|~_))+k[5]+4237533241&4294967295,A=T+(R<<21&4294967295|R>>>11),R=_+(T^(A|~x))+k[12]+1700485571&4294967295,_=A+(R<<6&4294967295|R>>>26),R=x+(A^(_|~T))+k[3]+2399980690&4294967295,x=_+(R<<10&4294967295|R>>>22),R=T+(_^(x|~A))+k[10]+4293915773&4294967295,T=x+(R<<15&4294967295|R>>>17),R=A+(x^(T|~_))+k[1]+2240044497&4294967295,A=T+(R<<21&4294967295|R>>>11),R=_+(T^(A|~x))+k[8]+1873313359&4294967295,_=A+(R<<6&4294967295|R>>>26),R=x+(A^(_|~T))+k[15]+4264355552&4294967295,x=_+(R<<10&4294967295|R>>>22),R=T+(_^(x|~A))+k[6]+2734768916&4294967295,T=x+(R<<15&4294967295|R>>>17),R=A+(x^(T|~_))+k[13]+1309151649&4294967295,A=T+(R<<21&4294967295|R>>>11),R=_+(T^(A|~x))+k[4]+4149444226&4294967295,_=A+(R<<6&4294967295|R>>>26),R=x+(A^(_|~T))+k[11]+3174756917&4294967295,x=_+(R<<10&4294967295|R>>>22),R=T+(_^(x|~A))+k[2]+718787259&4294967295,T=x+(R<<15&4294967295|R>>>17),R=A+(x^(T|~_))+k[9]+3951481745&4294967295,C.g[0]=C.g[0]+_&4294967295,C.g[1]=C.g[1]+(T+(R<<21&4294967295|R>>>11))&4294967295,C.g[2]=C.g[2]+T&4294967295,C.g[3]=C.g[3]+x&4294967295}r.prototype.u=function(C,_){_===void 0&&(_=C.length);for(var A=_-this.blockSize,k=this.B,T=this.h,x=0;x<_;){if(T==0)for(;x<=A;)i(this,C,x),x+=this.blockSize;if(typeof C=="string"){for(;x<_;)if(k[T++]=C.charCodeAt(x++),T==this.blockSize){i(this,k),T=0;break}}else for(;x<_;)if(k[T++]=C[x++],T==this.blockSize){i(this,k),T=0;break}}this.h=T,this.o+=_},r.prototype.v=function(){var C=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);C[0]=128;for(var _=1;_<C.length-8;++_)C[_]=0;var A=8*this.o;for(_=C.length-8;_<C.length;++_)C[_]=A&255,A/=256;for(this.u(C),C=Array(16),_=A=0;4>_;++_)for(var k=0;32>k;k+=8)C[A++]=this.g[_]>>>k&255;return C};function s(C,_){var A=a;return Object.prototype.hasOwnProperty.call(A,C)?A[C]:A[C]=_(C)}function o(C,_){this.h=_;for(var A=[],k=!0,T=C.length-1;0<=T;T--){var x=C[T]|0;k&&x==_||(A[T]=x,k=!1)}this.g=A}var a={};function u(C){return-128<=C&&128>C?s(C,function(_){return new o([_|0],0>_?-1:0)}):new o([C|0],0>C?-1:0)}function c(C){if(isNaN(C)||!isFinite(C))return f;if(0>C)return N(c(-C));for(var _=[],A=1,k=0;C>=A;k++)_[k]=C/A|0,A*=4294967296;return new o(_,0)}function h(C,_){if(C.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(C.charAt(0)=="-")return N(h(C.substring(1),_));if(0<=C.indexOf("-"))throw Error('number format error: interior "-" character');for(var A=c(Math.pow(_,8)),k=f,T=0;T<C.length;T+=8){var x=Math.min(8,C.length-T),R=parseInt(C.substring(T,T+x),_);8>x?(x=c(Math.pow(_,x)),k=k.j(x).add(c(R))):(k=k.j(A),k=k.add(c(R)))}return k}var f=u(0),m=u(1),y=u(16777216);t=o.prototype,t.m=function(){if(P(this))return-N(this).m();for(var C=0,_=1,A=0;A<this.g.length;A++){var k=this.i(A);C+=(0<=k?k:4294967296+k)*_,_*=4294967296}return C},t.toString=function(C){if(C=C||10,2>C||36<C)throw Error("radix out of range: "+C);if(v(this))return"0";if(P(this))return"-"+N(this).toString(C);for(var _=c(Math.pow(C,6)),A=this,k="";;){var T=D(A,_).g;A=I(A,T.j(_));var x=((0<A.g.length?A.g[0]:A.h)>>>0).toString(C);if(A=T,v(A))return x+k;for(;6>x.length;)x="0"+x;k=x+k}},t.i=function(C){return 0>C?0:C<this.g.length?this.g[C]:this.h};function v(C){if(C.h!=0)return!1;for(var _=0;_<C.g.length;_++)if(C.g[_]!=0)return!1;return!0}function P(C){return C.h==-1}t.l=function(C){return C=I(this,C),P(C)?-1:v(C)?0:1};function N(C){for(var _=C.g.length,A=[],k=0;k<_;k++)A[k]=~C.g[k];return new o(A,~C.h).add(m)}t.abs=function(){return P(this)?N(this):this},t.add=function(C){for(var _=Math.max(this.g.length,C.g.length),A=[],k=0,T=0;T<=_;T++){var x=k+(this.i(T)&65535)+(C.i(T)&65535),R=(x>>>16)+(this.i(T)>>>16)+(C.i(T)>>>16);k=R>>>16,x&=65535,R&=65535,A[T]=R<<16|x}return new o(A,A[A.length-1]&-2147483648?-1:0)};function I(C,_){return C.add(N(_))}t.j=function(C){if(v(this)||v(C))return f;if(P(this))return P(C)?N(this).j(N(C)):N(N(this).j(C));if(P(C))return N(this.j(N(C)));if(0>this.l(y)&&0>C.l(y))return c(this.m()*C.m());for(var _=this.g.length+C.g.length,A=[],k=0;k<2*_;k++)A[k]=0;for(k=0;k<this.g.length;k++)for(var T=0;T<C.g.length;T++){var x=this.i(k)>>>16,R=this.i(k)&65535,ye=C.i(T)>>>16,Nt=C.i(T)&65535;A[2*k+2*T]+=R*Nt,E(A,2*k+2*T),A[2*k+2*T+1]+=x*Nt,E(A,2*k+2*T+1),A[2*k+2*T+1]+=R*ye,E(A,2*k+2*T+1),A[2*k+2*T+2]+=x*ye,E(A,2*k+2*T+2)}for(k=0;k<_;k++)A[k]=A[2*k+1]<<16|A[2*k];for(k=_;k<2*_;k++)A[k]=0;return new o(A,0)};function E(C,_){for(;(C[_]&65535)!=C[_];)C[_+1]+=C[_]>>>16,C[_]&=65535,_++}function S(C,_){this.g=C,this.h=_}function D(C,_){if(v(_))throw Error("division by zero");if(v(C))return new S(f,f);if(P(C))return _=D(N(C),_),new S(N(_.g),N(_.h));if(P(_))return _=D(C,N(_)),new S(N(_.g),_.h);if(30<C.g.length){if(P(C)||P(_))throw Error("slowDivide_ only works with positive integers.");for(var A=m,k=_;0>=k.l(C);)A=M(A),k=M(k);var T=U(A,1),x=U(k,1);for(k=U(k,2),A=U(A,2);!v(k);){var R=x.add(k);0>=R.l(C)&&(T=T.add(A),x=R),k=U(k,1),A=U(A,1)}return _=I(C,T.j(_)),new S(T,_)}for(T=f;0<=C.l(_);){for(A=Math.max(1,Math.floor(C.m()/_.m())),k=Math.ceil(Math.log(A)/Math.LN2),k=48>=k?1:Math.pow(2,k-48),x=c(A),R=x.j(_);P(R)||0<R.l(C);)A-=k,x=c(A),R=x.j(_);v(x)&&(x=m),T=T.add(x),C=I(C,R)}return new S(T,C)}t.A=function(C){return D(this,C).h},t.and=function(C){for(var _=Math.max(this.g.length,C.g.length),A=[],k=0;k<_;k++)A[k]=this.i(k)&C.i(k);return new o(A,this.h&C.h)},t.or=function(C){for(var _=Math.max(this.g.length,C.g.length),A=[],k=0;k<_;k++)A[k]=this.i(k)|C.i(k);return new o(A,this.h|C.h)},t.xor=function(C){for(var _=Math.max(this.g.length,C.g.length),A=[],k=0;k<_;k++)A[k]=this.i(k)^C.i(k);return new o(A,this.h^C.h)};function M(C){for(var _=C.g.length+1,A=[],k=0;k<_;k++)A[k]=C.i(k)<<1|C.i(k-1)>>>31;return new o(A,C.h)}function U(C,_){var A=_>>5;_%=32;for(var k=C.g.length-A,T=[],x=0;x<k;x++)T[x]=0<_?C.i(x+A)>>>_|C.i(x+A+1)<<32-_:C.i(x+A);return new o(T,C.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,dC=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=h,Ni=o}).apply(typeof Ww<"u"?Ww:typeof self<"u"?self:typeof window<"u"?window:{});var wu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var fC,pC,ua,mC,Gu,Mp,gC,_C,yC;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,d,p){return l==Array.prototype||l==Object.prototype||(l[d]=p.value),l};function n(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof wu=="object"&&wu];for(var d=0;d<l.length;++d){var p=l[d];if(p&&p.Math==Math)return p}throw Error("Cannot find global object")}var r=n(this);function i(l,d){if(d)e:{var p=r;l=l.split(".");for(var g=0;g<l.length-1;g++){var O=l[g];if(!(O in p))break e;p=p[O]}l=l[l.length-1],g=p[l],d=d(g),d!=g&&d!=null&&e(p,l,{configurable:!0,writable:!0,value:d})}}function s(l,d){l instanceof String&&(l+="");var p=0,g=!1,O={next:function(){if(!g&&p<l.length){var b=p++;return{value:d(b,l[b]),done:!1}}return g=!0,{done:!0,value:void 0}}};return O[Symbol.iterator]=function(){return O},O}i("Array.prototype.values",function(l){return l||function(){return s(this,function(d,p){return p})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function u(l){var d=typeof l;return d=d!="object"?d:l?Array.isArray(l)?"array":d:"null",d=="array"||d=="object"&&typeof l.length=="number"}function c(l){var d=typeof l;return d=="object"&&l!=null||d=="function"}function h(l,d,p){return l.call.apply(l.bind,arguments)}function f(l,d,p){if(!l)throw Error();if(2<arguments.length){var g=Array.prototype.slice.call(arguments,2);return function(){var O=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(O,g),l.apply(d,O)}}return function(){return l.apply(d,arguments)}}function m(l,d,p){return m=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?h:f,m.apply(null,arguments)}function y(l,d){var p=Array.prototype.slice.call(arguments,1);return function(){var g=p.slice();return g.push.apply(g,arguments),l.apply(this,g)}}function v(l,d){function p(){}p.prototype=d.prototype,l.aa=d.prototype,l.prototype=new p,l.prototype.constructor=l,l.Qb=function(g,O,b){for(var B=Array(arguments.length-2),pe=2;pe<arguments.length;pe++)B[pe-2]=arguments[pe];return d.prototype[O].apply(g,B)}}function P(l){const d=l.length;if(0<d){const p=Array(d);for(let g=0;g<d;g++)p[g]=l[g];return p}return[]}function N(l,d){for(let p=1;p<arguments.length;p++){const g=arguments[p];if(u(g)){const O=l.length||0,b=g.length||0;l.length=O+b;for(let B=0;B<b;B++)l[O+B]=g[B]}else l.push(g)}}class I{constructor(d,p){this.i=d,this.j=p,this.h=0,this.g=null}get(){let d;return 0<this.h?(this.h--,d=this.g,this.g=d.next,d.next=null):d=this.i(),d}}function E(l){return/^[\s\xa0]*$/.test(l)}function S(){var l=a.navigator;return l&&(l=l.userAgent)?l:""}function D(l){return D[" "](l),l}D[" "]=function(){};var M=S().indexOf("Gecko")!=-1&&!(S().toLowerCase().indexOf("webkit")!=-1&&S().indexOf("Edge")==-1)&&!(S().indexOf("Trident")!=-1||S().indexOf("MSIE")!=-1)&&S().indexOf("Edge")==-1;function U(l,d,p){for(const g in l)d.call(p,l[g],g,l)}function C(l,d){for(const p in l)d.call(void 0,l[p],p,l)}function _(l){const d={};for(const p in l)d[p]=l[p];return d}const A="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function k(l,d){let p,g;for(let O=1;O<arguments.length;O++){g=arguments[O];for(p in g)l[p]=g[p];for(let b=0;b<A.length;b++)p=A[b],Object.prototype.hasOwnProperty.call(g,p)&&(l[p]=g[p])}}function T(l){var d=1;l=l.split(":");const p=[];for(;0<d&&l.length;)p.push(l.shift()),d--;return l.length&&p.push(l.join(":")),p}function x(l){a.setTimeout(()=>{throw l},0)}function R(){var l=Y;let d=null;return l.g&&(d=l.g,l.g=l.g.next,l.g||(l.h=null),d.next=null),d}class ye{constructor(){this.h=this.g=null}add(d,p){const g=Nt.get();g.set(d,p),this.h?this.h.next=g:this.g=g,this.h=g}}var Nt=new I(()=>new Rn,l=>l.reset());class Rn{constructor(){this.next=this.g=this.h=null}set(d,p){this.h=d,this.g=p,this.next=null}reset(){this.next=this.g=this.h=null}}let Bn,$=!1,Y=new ye,Z=()=>{const l=a.Promise.resolve(void 0);Bn=()=>{l.then(Ae)}};var Ae=()=>{for(var l;l=R();){try{l.h.call(l.g)}catch(p){x(p)}var d=Nt;d.j(l),100>d.h&&(d.h++,l.next=d.g,d.g=l)}$=!1};function fe(){this.s=this.s,this.C=this.C}fe.prototype.s=!1,fe.prototype.ma=function(){this.s||(this.s=!0,this.N())},fe.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Le(l,d){this.type=l,this.g=this.target=d,this.defaultPrevented=!1}Le.prototype.h=function(){this.defaultPrevented=!0};var zn=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var l=!1,d=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const p=()=>{};a.addEventListener("test",p,d),a.removeEventListener("test",p,d)}catch{}return l}();function $n(l,d){if(Le.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var p=this.type=l.type,g=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=d,d=l.relatedTarget){if(M){e:{try{D(d.nodeName);var O=!0;break e}catch{}O=!1}O||(d=null)}}else p=="mouseover"?d=l.fromElement:p=="mouseout"&&(d=l.toElement);this.relatedTarget=d,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:Wn[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&$n.aa.h.call(this)}}v($n,Le);var Wn={2:"touch",3:"pen",4:"mouse"};$n.prototype.h=function(){$n.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var Hn="closure_listenable_"+(1e6*Math.random()|0),I1=0;function S1(l,d,p,g,O){this.listener=l,this.proxy=null,this.src=d,this.type=p,this.capture=!!g,this.ha=O,this.key=++I1,this.da=this.fa=!1}function Ul(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function Fl(l){this.src=l,this.g={},this.h=0}Fl.prototype.add=function(l,d,p,g,O){var b=l.toString();l=this.g[b],l||(l=this.g[b]=[],this.h++);var B=Zh(l,d,g,O);return-1<B?(d=l[B],p||(d.fa=!1)):(d=new S1(d,this.src,b,!!g,O),d.fa=p,l.push(d)),d};function Jh(l,d){var p=d.type;if(p in l.g){var g=l.g[p],O=Array.prototype.indexOf.call(g,d,void 0),b;(b=0<=O)&&Array.prototype.splice.call(g,O,1),b&&(Ul(d),l.g[p].length==0&&(delete l.g[p],l.h--))}}function Zh(l,d,p,g){for(var O=0;O<l.length;++O){var b=l[O];if(!b.da&&b.listener==d&&b.capture==!!p&&b.ha==g)return O}return-1}var ed="closure_lm_"+(1e6*Math.random()|0),td={};function j_(l,d,p,g,O){if(Array.isArray(d)){for(var b=0;b<d.length;b++)j_(l,d[b],p,g,O);return null}return p=$_(p),l&&l[Hn]?l.K(d,p,c(g)?!!g.capture:!!g,O):C1(l,d,p,!1,g,O)}function C1(l,d,p,g,O,b){if(!d)throw Error("Invalid event type");var B=c(O)?!!O.capture:!!O,pe=rd(l);if(pe||(l[ed]=pe=new Fl(l)),p=pe.add(d,p,g,B,b),p.proxy)return p;if(g=R1(),p.proxy=g,g.src=l,g.listener=p,l.addEventListener)zn||(O=B),O===void 0&&(O=!1),l.addEventListener(d.toString(),g,O);else if(l.attachEvent)l.attachEvent(z_(d.toString()),g);else if(l.addListener&&l.removeListener)l.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return p}function R1(){function l(p){return d.call(l.src,l.listener,p)}const d=A1;return l}function B_(l,d,p,g,O){if(Array.isArray(d))for(var b=0;b<d.length;b++)B_(l,d[b],p,g,O);else g=c(g)?!!g.capture:!!g,p=$_(p),l&&l[Hn]?(l=l.i,d=String(d).toString(),d in l.g&&(b=l.g[d],p=Zh(b,p,g,O),-1<p&&(Ul(b[p]),Array.prototype.splice.call(b,p,1),b.length==0&&(delete l.g[d],l.h--)))):l&&(l=rd(l))&&(d=l.g[d.toString()],l=-1,d&&(l=Zh(d,p,g,O)),(p=-1<l?d[l]:null)&&nd(p))}function nd(l){if(typeof l!="number"&&l&&!l.da){var d=l.src;if(d&&d[Hn])Jh(d.i,l);else{var p=l.type,g=l.proxy;d.removeEventListener?d.removeEventListener(p,g,l.capture):d.detachEvent?d.detachEvent(z_(p),g):d.addListener&&d.removeListener&&d.removeListener(g),(p=rd(d))?(Jh(p,l),p.h==0&&(p.src=null,d[ed]=null)):Ul(l)}}}function z_(l){return l in td?td[l]:td[l]="on"+l}function A1(l,d){if(l.da)l=!0;else{d=new $n(d,this);var p=l.listener,g=l.ha||l.src;l.fa&&nd(l),l=p.call(g,d)}return l}function rd(l){return l=l[ed],l instanceof Fl?l:null}var id="__closure_events_fn_"+(1e9*Math.random()>>>0);function $_(l){return typeof l=="function"?l:(l[id]||(l[id]=function(d){return l.handleEvent(d)}),l[id])}function ut(){fe.call(this),this.i=new Fl(this),this.M=this,this.F=null}v(ut,fe),ut.prototype[Hn]=!0,ut.prototype.removeEventListener=function(l,d,p,g){B_(this,l,d,p,g)};function It(l,d){var p,g=l.F;if(g)for(p=[];g;g=g.F)p.push(g);if(l=l.M,g=d.type||d,typeof d=="string")d=new Le(d,l);else if(d instanceof Le)d.target=d.target||l;else{var O=d;d=new Le(g,l),k(d,O)}if(O=!0,p)for(var b=p.length-1;0<=b;b--){var B=d.g=p[b];O=jl(B,g,!0,d)&&O}if(B=d.g=l,O=jl(B,g,!0,d)&&O,O=jl(B,g,!1,d)&&O,p)for(b=0;b<p.length;b++)B=d.g=p[b],O=jl(B,g,!1,d)&&O}ut.prototype.N=function(){if(ut.aa.N.call(this),this.i){var l=this.i,d;for(d in l.g){for(var p=l.g[d],g=0;g<p.length;g++)Ul(p[g]);delete l.g[d],l.h--}}this.F=null},ut.prototype.K=function(l,d,p,g){return this.i.add(String(l),d,!1,p,g)},ut.prototype.L=function(l,d,p,g){return this.i.add(String(l),d,!0,p,g)};function jl(l,d,p,g){if(d=l.i.g[String(d)],!d)return!0;d=d.concat();for(var O=!0,b=0;b<d.length;++b){var B=d[b];if(B&&!B.da&&B.capture==p){var pe=B.listener,Ze=B.ha||B.src;B.fa&&Jh(l.i,B),O=pe.call(Ze,g)!==!1&&O}}return O&&!g.defaultPrevented}function W_(l,d,p){if(typeof l=="function")p&&(l=m(l,p));else if(l&&typeof l.handleEvent=="function")l=m(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(d)?-1:a.setTimeout(l,d||0)}function H_(l){l.g=W_(()=>{l.g=null,l.i&&(l.i=!1,H_(l))},l.l);const d=l.h;l.h=null,l.m.apply(null,d)}class k1 extends fe{constructor(d,p){super(),this.m=d,this.l=p,this.h=null,this.i=!1,this.g=null}j(d){this.h=arguments,this.g?this.i=!0:H_(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ko(l){fe.call(this),this.h=l,this.g={}}v(ko,fe);var q_=[];function K_(l){U(l.g,function(d,p){this.g.hasOwnProperty(p)&&nd(d)},l),l.g={}}ko.prototype.N=function(){ko.aa.N.call(this),K_(this)},ko.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var sd=a.JSON.stringify,P1=a.JSON.parse,N1=class{stringify(l){return a.JSON.stringify(l,void 0)}parse(l){return a.JSON.parse(l,void 0)}};function od(){}od.prototype.h=null;function G_(l){return l.h||(l.h=l.i())}function Q_(){}var Po={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function ad(){Le.call(this,"d")}v(ad,Le);function ld(){Le.call(this,"c")}v(ld,Le);var hi={},Y_=null;function Bl(){return Y_=Y_||new ut}hi.La="serverreachability";function X_(l){Le.call(this,hi.La,l)}v(X_,Le);function No(l){const d=Bl();It(d,new X_(d))}hi.STAT_EVENT="statevent";function J_(l,d){Le.call(this,hi.STAT_EVENT,l),this.stat=d}v(J_,Le);function St(l){const d=Bl();It(d,new J_(d,l))}hi.Ma="timingevent";function Z_(l,d){Le.call(this,hi.Ma,l),this.size=d}v(Z_,Le);function xo(l,d){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){l()},d)}function Do(){this.g=!0}Do.prototype.xa=function(){this.g=!1};function x1(l,d,p,g,O,b){l.info(function(){if(l.g)if(b)for(var B="",pe=b.split("&"),Ze=0;Ze<pe.length;Ze++){var le=pe[Ze].split("=");if(1<le.length){var ct=le[0];le=le[1];var ht=ct.split("_");B=2<=ht.length&&ht[1]=="type"?B+(ct+"="+le+"&"):B+(ct+"=redacted&")}}else B=null;else B=b;return"XMLHTTP REQ ("+g+") [attempt "+O+"]: "+d+`
`+p+`
`+B})}function D1(l,d,p,g,O,b,B){l.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+O+"]: "+d+`
`+p+`
`+b+" "+B})}function ss(l,d,p,g){l.info(function(){return"XMLHTTP TEXT ("+d+"): "+b1(l,p)+(g?" "+g:"")})}function O1(l,d){l.info(function(){return"TIMEOUT: "+d})}Do.prototype.info=function(){};function b1(l,d){if(!l.g)return d;if(!d)return null;try{var p=JSON.parse(d);if(p){for(l=0;l<p.length;l++)if(Array.isArray(p[l])){var g=p[l];if(!(2>g.length)){var O=g[1];if(Array.isArray(O)&&!(1>O.length)){var b=O[0];if(b!="noop"&&b!="stop"&&b!="close")for(var B=1;B<O.length;B++)O[B]=""}}}}return sd(p)}catch{return d}}var zl={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},ey={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},ud;function $l(){}v($l,od),$l.prototype.g=function(){return new XMLHttpRequest},$l.prototype.i=function(){return{}},ud=new $l;function vr(l,d,p,g){this.j=l,this.i=d,this.l=p,this.R=g||1,this.U=new ko(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ty}function ty(){this.i=null,this.g="",this.h=!1}var ny={},cd={};function hd(l,d,p){l.L=1,l.v=Kl(qn(d)),l.m=p,l.P=!0,ry(l,null)}function ry(l,d){l.F=Date.now(),Wl(l),l.A=qn(l.v);var p=l.A,g=l.R;Array.isArray(g)||(g=[String(g)]),_y(p.i,"t",g),l.C=0,p=l.j.J,l.h=new ty,l.g=Ly(l.j,p?d:null,!l.m),0<l.O&&(l.M=new k1(m(l.Y,l,l.g),l.O)),d=l.U,p=l.g,g=l.ca;var O="readystatechange";Array.isArray(O)||(O&&(q_[0]=O.toString()),O=q_);for(var b=0;b<O.length;b++){var B=j_(p,O[b],g||d.handleEvent,!1,d.h||d);if(!B)break;d.g[B.key]=B}d=l.H?_(l.H):{},l.m?(l.u||(l.u="POST"),d["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,d)):(l.u="GET",l.g.ea(l.A,l.u,null,d)),No(),x1(l.i,l.u,l.A,l.l,l.R,l.m)}vr.prototype.ca=function(l){l=l.target;const d=this.M;d&&Kn(l)==3?d.j():this.Y(l)},vr.prototype.Y=function(l){try{if(l==this.g)e:{const ht=Kn(this.g);var d=this.g.Ba();const ls=this.g.Z();if(!(3>ht)&&(ht!=3||this.g&&(this.h.h||this.g.oa()||Sy(this.g)))){this.J||ht!=4||d==7||(d==8||0>=ls?No(3):No(2)),dd(this);var p=this.g.Z();this.X=p;t:if(iy(this)){var g=Sy(this.g);l="";var O=g.length,b=Kn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){di(this),Oo(this);var B="";break t}this.h.i=new a.TextDecoder}for(d=0;d<O;d++)this.h.h=!0,l+=this.h.i.decode(g[d],{stream:!(b&&d==O-1)});g.length=0,this.h.g+=l,this.C=0,B=this.h.g}else B=this.g.oa();if(this.o=p==200,D1(this.i,this.u,this.A,this.l,this.R,ht,p),this.o){if(this.T&&!this.K){t:{if(this.g){var pe,Ze=this.g;if((pe=Ze.g?Ze.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!E(pe)){var le=pe;break t}}le=null}if(p=le)ss(this.i,this.l,p,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,fd(this,p);else{this.o=!1,this.s=3,St(12),di(this),Oo(this);break e}}if(this.P){p=!0;let un;for(;!this.J&&this.C<B.length;)if(un=L1(this,B),un==cd){ht==4&&(this.s=4,St(14),p=!1),ss(this.i,this.l,null,"[Incomplete Response]");break}else if(un==ny){this.s=4,St(15),ss(this.i,this.l,B,"[Invalid Chunk]"),p=!1;break}else ss(this.i,this.l,un,null),fd(this,un);if(iy(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ht!=4||B.length!=0||this.h.h||(this.s=1,St(16),p=!1),this.o=this.o&&p,!p)ss(this.i,this.l,B,"[Invalid Chunked Response]"),di(this),Oo(this);else if(0<B.length&&!this.W){this.W=!0;var ct=this.j;ct.g==this&&ct.ba&&!ct.M&&(ct.j.info("Great, no buffering proxy detected. Bytes received: "+B.length),vd(ct),ct.M=!0,St(11))}}else ss(this.i,this.l,B,null),fd(this,B);ht==4&&di(this),this.o&&!this.J&&(ht==4?xy(this.j,this):(this.o=!1,Wl(this)))}else J1(this.g),p==400&&0<B.indexOf("Unknown SID")?(this.s=3,St(12)):(this.s=0,St(13)),di(this),Oo(this)}}}catch{}finally{}};function iy(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function L1(l,d){var p=l.C,g=d.indexOf(`
`,p);return g==-1?cd:(p=Number(d.substring(p,g)),isNaN(p)?ny:(g+=1,g+p>d.length?cd:(d=d.slice(g,g+p),l.C=g+p,d)))}vr.prototype.cancel=function(){this.J=!0,di(this)};function Wl(l){l.S=Date.now()+l.I,sy(l,l.I)}function sy(l,d){if(l.B!=null)throw Error("WatchDog timer not null");l.B=xo(m(l.ba,l),d)}function dd(l){l.B&&(a.clearTimeout(l.B),l.B=null)}vr.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(O1(this.i,this.A),this.L!=2&&(No(),St(17)),di(this),this.s=2,Oo(this)):sy(this,this.S-l)};function Oo(l){l.j.G==0||l.J||xy(l.j,l)}function di(l){dd(l);var d=l.M;d&&typeof d.ma=="function"&&d.ma(),l.M=null,K_(l.U),l.g&&(d=l.g,l.g=null,d.abort(),d.ma())}function fd(l,d){try{var p=l.j;if(p.G!=0&&(p.g==l||pd(p.h,l))){if(!l.K&&pd(p.h,l)&&p.G==3){try{var g=p.Da.g.parse(d)}catch{g=null}if(Array.isArray(g)&&g.length==3){var O=g;if(O[0]==0){e:if(!p.u){if(p.g)if(p.g.F+3e3<l.F)Jl(p),Yl(p);else break e;yd(p),St(18)}}else p.za=O[1],0<p.za-p.T&&37500>O[2]&&p.F&&p.v==0&&!p.C&&(p.C=xo(m(p.Za,p),6e3));if(1>=ly(p.h)&&p.ca){try{p.ca()}catch{}p.ca=void 0}}else pi(p,11)}else if((l.K||p.g==l)&&Jl(p),!E(d))for(O=p.Da.g.parse(d),d=0;d<O.length;d++){let le=O[d];if(p.T=le[0],le=le[1],p.G==2)if(le[0]=="c"){p.K=le[1],p.ia=le[2];const ct=le[3];ct!=null&&(p.la=ct,p.j.info("VER="+p.la));const ht=le[4];ht!=null&&(p.Aa=ht,p.j.info("SVER="+p.Aa));const ls=le[5];ls!=null&&typeof ls=="number"&&0<ls&&(g=1.5*ls,p.L=g,p.j.info("backChannelRequestTimeoutMs_="+g)),g=p;const un=l.g;if(un){const eu=un.g?un.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(eu){var b=g.h;b.g||eu.indexOf("spdy")==-1&&eu.indexOf("quic")==-1&&eu.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(md(b,b.h),b.h=null))}if(g.D){const wd=un.g?un.g.getResponseHeader("X-HTTP-Session-Id"):null;wd&&(g.ya=wd,ve(g.I,g.D,wd))}}p.G=3,p.l&&p.l.ua(),p.ba&&(p.R=Date.now()-l.F,p.j.info("Handshake RTT: "+p.R+"ms")),g=p;var B=l;if(g.qa=by(g,g.J?g.ia:null,g.W),B.K){uy(g.h,B);var pe=B,Ze=g.L;Ze&&(pe.I=Ze),pe.B&&(dd(pe),Wl(pe)),g.g=B}else Py(g);0<p.i.length&&Xl(p)}else le[0]!="stop"&&le[0]!="close"||pi(p,7);else p.G==3&&(le[0]=="stop"||le[0]=="close"?le[0]=="stop"?pi(p,7):_d(p):le[0]!="noop"&&p.l&&p.l.ta(le),p.v=0)}}No(4)}catch{}}var M1=class{constructor(l,d){this.g=l,this.map=d}};function oy(l){this.l=l||10,a.PerformanceNavigationTiming?(l=a.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function ay(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function ly(l){return l.h?1:l.g?l.g.size:0}function pd(l,d){return l.h?l.h==d:l.g?l.g.has(d):!1}function md(l,d){l.g?l.g.add(d):l.h=d}function uy(l,d){l.h&&l.h==d?l.h=null:l.g&&l.g.has(d)&&l.g.delete(d)}oy.prototype.cancel=function(){if(this.i=cy(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function cy(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let d=l.i;for(const p of l.g.values())d=d.concat(p.D);return d}return P(l.i)}function V1(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(u(l)){for(var d=[],p=l.length,g=0;g<p;g++)d.push(l[g]);return d}d=[],p=0;for(g in l)d[p++]=l[g];return d}function U1(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(u(l)||typeof l=="string"){var d=[];l=l.length;for(var p=0;p<l;p++)d.push(p);return d}d=[],p=0;for(const g in l)d[p++]=g;return d}}}function hy(l,d){if(l.forEach&&typeof l.forEach=="function")l.forEach(d,void 0);else if(u(l)||typeof l=="string")Array.prototype.forEach.call(l,d,void 0);else for(var p=U1(l),g=V1(l),O=g.length,b=0;b<O;b++)d.call(void 0,g[b],p&&p[b],l)}var dy=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function F1(l,d){if(l){l=l.split("&");for(var p=0;p<l.length;p++){var g=l[p].indexOf("="),O=null;if(0<=g){var b=l[p].substring(0,g);O=l[p].substring(g+1)}else b=l[p];d(b,O?decodeURIComponent(O.replace(/\+/g," ")):"")}}}function fi(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof fi){this.h=l.h,Hl(this,l.j),this.o=l.o,this.g=l.g,ql(this,l.s),this.l=l.l;var d=l.i,p=new Mo;p.i=d.i,d.g&&(p.g=new Map(d.g),p.h=d.h),fy(this,p),this.m=l.m}else l&&(d=String(l).match(dy))?(this.h=!1,Hl(this,d[1]||"",!0),this.o=bo(d[2]||""),this.g=bo(d[3]||"",!0),ql(this,d[4]),this.l=bo(d[5]||"",!0),fy(this,d[6]||"",!0),this.m=bo(d[7]||"")):(this.h=!1,this.i=new Mo(null,this.h))}fi.prototype.toString=function(){var l=[],d=this.j;d&&l.push(Lo(d,py,!0),":");var p=this.g;return(p||d=="file")&&(l.push("//"),(d=this.o)&&l.push(Lo(d,py,!0),"@"),l.push(encodeURIComponent(String(p)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),p=this.s,p!=null&&l.push(":",String(p))),(p=this.l)&&(this.g&&p.charAt(0)!="/"&&l.push("/"),l.push(Lo(p,p.charAt(0)=="/"?z1:B1,!0))),(p=this.i.toString())&&l.push("?",p),(p=this.m)&&l.push("#",Lo(p,W1)),l.join("")};function qn(l){return new fi(l)}function Hl(l,d,p){l.j=p?bo(d,!0):d,l.j&&(l.j=l.j.replace(/:$/,""))}function ql(l,d){if(d){if(d=Number(d),isNaN(d)||0>d)throw Error("Bad port number "+d);l.s=d}else l.s=null}function fy(l,d,p){d instanceof Mo?(l.i=d,H1(l.i,l.h)):(p||(d=Lo(d,$1)),l.i=new Mo(d,l.h))}function ve(l,d,p){l.i.set(d,p)}function Kl(l){return ve(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function bo(l,d){return l?d?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Lo(l,d,p){return typeof l=="string"?(l=encodeURI(l).replace(d,j1),p&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function j1(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var py=/[#\/\?@]/g,B1=/[#\?:]/g,z1=/[#\?]/g,$1=/[#\?@]/g,W1=/#/g;function Mo(l,d){this.h=this.g=null,this.i=l||null,this.j=!!d}function wr(l){l.g||(l.g=new Map,l.h=0,l.i&&F1(l.i,function(d,p){l.add(decodeURIComponent(d.replace(/\+/g," ")),p)}))}t=Mo.prototype,t.add=function(l,d){wr(this),this.i=null,l=os(this,l);var p=this.g.get(l);return p||this.g.set(l,p=[]),p.push(d),this.h+=1,this};function my(l,d){wr(l),d=os(l,d),l.g.has(d)&&(l.i=null,l.h-=l.g.get(d).length,l.g.delete(d))}function gy(l,d){return wr(l),d=os(l,d),l.g.has(d)}t.forEach=function(l,d){wr(this),this.g.forEach(function(p,g){p.forEach(function(O){l.call(d,O,g,this)},this)},this)},t.na=function(){wr(this);const l=Array.from(this.g.values()),d=Array.from(this.g.keys()),p=[];for(let g=0;g<d.length;g++){const O=l[g];for(let b=0;b<O.length;b++)p.push(d[g])}return p},t.V=function(l){wr(this);let d=[];if(typeof l=="string")gy(this,l)&&(d=d.concat(this.g.get(os(this,l))));else{l=Array.from(this.g.values());for(let p=0;p<l.length;p++)d=d.concat(l[p])}return d},t.set=function(l,d){return wr(this),this.i=null,l=os(this,l),gy(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[d]),this.h+=1,this},t.get=function(l,d){return l?(l=this.V(l),0<l.length?String(l[0]):d):d};function _y(l,d,p){my(l,d),0<p.length&&(l.i=null,l.g.set(os(l,d),P(p)),l.h+=p.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],d=Array.from(this.g.keys());for(var p=0;p<d.length;p++){var g=d[p];const b=encodeURIComponent(String(g)),B=this.V(g);for(g=0;g<B.length;g++){var O=b;B[g]!==""&&(O+="="+encodeURIComponent(String(B[g]))),l.push(O)}}return this.i=l.join("&")};function os(l,d){return d=String(d),l.j&&(d=d.toLowerCase()),d}function H1(l,d){d&&!l.j&&(wr(l),l.i=null,l.g.forEach(function(p,g){var O=g.toLowerCase();g!=O&&(my(this,g),_y(this,O,p))},l)),l.j=d}function q1(l,d){const p=new Do;if(a.Image){const g=new Image;g.onload=y(Er,p,"TestLoadImage: loaded",!0,d,g),g.onerror=y(Er,p,"TestLoadImage: error",!1,d,g),g.onabort=y(Er,p,"TestLoadImage: abort",!1,d,g),g.ontimeout=y(Er,p,"TestLoadImage: timeout",!1,d,g),a.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=l}else d(!1)}function K1(l,d){const p=new Do,g=new AbortController,O=setTimeout(()=>{g.abort(),Er(p,"TestPingServer: timeout",!1,d)},1e4);fetch(l,{signal:g.signal}).then(b=>{clearTimeout(O),b.ok?Er(p,"TestPingServer: ok",!0,d):Er(p,"TestPingServer: server error",!1,d)}).catch(()=>{clearTimeout(O),Er(p,"TestPingServer: error",!1,d)})}function Er(l,d,p,g,O){try{O&&(O.onload=null,O.onerror=null,O.onabort=null,O.ontimeout=null),g(p)}catch{}}function G1(){this.g=new N1}function Q1(l,d,p){const g=p||"";try{hy(l,function(O,b){let B=O;c(O)&&(B=sd(O)),d.push(g+b+"="+encodeURIComponent(B))})}catch(O){throw d.push(g+"type="+encodeURIComponent("_badmap")),O}}function Vo(l){this.l=l.Ub||null,this.j=l.eb||!1}v(Vo,od),Vo.prototype.g=function(){return new Gl(this.l,this.j)},Vo.prototype.i=function(l){return function(){return l}}({});function Gl(l,d){ut.call(this),this.D=l,this.o=d,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}v(Gl,ut),t=Gl.prototype,t.open=function(l,d){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=d,this.readyState=1,Fo(this)},t.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const d={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(d.body=l),(this.D||a).fetch(new Request(this.A,d)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Uo(this)),this.readyState=0},t.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,Fo(this)),this.g&&(this.readyState=3,Fo(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;yy(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function yy(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}t.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var d=l.value?l.value:new Uint8Array(0);(d=this.v.decode(d,{stream:!l.done}))&&(this.response=this.responseText+=d)}l.done?Uo(this):Fo(this),this.readyState==3&&yy(this)}},t.Ra=function(l){this.g&&(this.response=this.responseText=l,Uo(this))},t.Qa=function(l){this.g&&(this.response=l,Uo(this))},t.ga=function(){this.g&&Uo(this)};function Uo(l){l.readyState=4,l.l=null,l.j=null,l.v=null,Fo(l)}t.setRequestHeader=function(l,d){this.u.append(l,d)},t.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],d=this.h.entries();for(var p=d.next();!p.done;)p=p.value,l.push(p[0]+": "+p[1]),p=d.next();return l.join(`\r
`)};function Fo(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(Gl.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function vy(l){let d="";return U(l,function(p,g){d+=g,d+=":",d+=p,d+=`\r
`}),d}function gd(l,d,p){e:{for(g in p){var g=!1;break e}g=!0}g||(p=vy(p),typeof l=="string"?p!=null&&encodeURIComponent(String(p)):ve(l,d,p))}function xe(l){ut.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}v(xe,ut);var Y1=/^https?$/i,X1=["POST","PUT"];t=xe.prototype,t.Ha=function(l){this.J=l},t.ea=function(l,d,p,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);d=d?d.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():ud.g(),this.v=this.o?G_(this.o):G_(ud),this.g.onreadystatechange=m(this.Ea,this);try{this.B=!0,this.g.open(d,String(l),!0),this.B=!1}catch(b){wy(this,b);return}if(l=p||"",p=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var O in g)p.set(O,g[O]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const b of g.keys())p.set(b,g.get(b));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(p.keys()).find(b=>b.toLowerCase()=="content-type"),O=a.FormData&&l instanceof a.FormData,!(0<=Array.prototype.indexOf.call(X1,d,void 0))||g||O||p.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,B]of p)this.g.setRequestHeader(b,B);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Iy(this),this.u=!0,this.g.send(l),this.u=!1}catch(b){wy(this,b)}};function wy(l,d){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=d,l.m=5,Ey(l),Ql(l)}function Ey(l){l.A||(l.A=!0,It(l,"complete"),It(l,"error"))}t.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,It(this,"complete"),It(this,"abort"),Ql(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ql(this,!0)),xe.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?Ty(this):this.bb())},t.bb=function(){Ty(this)};function Ty(l){if(l.h&&typeof o<"u"&&(!l.v[1]||Kn(l)!=4||l.Z()!=2)){if(l.u&&Kn(l)==4)W_(l.Ea,0,l);else if(It(l,"readystatechange"),Kn(l)==4){l.h=!1;try{const B=l.Z();e:switch(B){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var d=!0;break e;default:d=!1}var p;if(!(p=d)){var g;if(g=B===0){var O=String(l.D).match(dy)[1]||null;!O&&a.self&&a.self.location&&(O=a.self.location.protocol.slice(0,-1)),g=!Y1.test(O?O.toLowerCase():"")}p=g}if(p)It(l,"complete"),It(l,"success");else{l.m=6;try{var b=2<Kn(l)?l.g.statusText:""}catch{b=""}l.l=b+" ["+l.Z()+"]",Ey(l)}}finally{Ql(l)}}}}function Ql(l,d){if(l.g){Iy(l);const p=l.g,g=l.v[0]?()=>{}:null;l.g=null,l.v=null,d||It(l,"ready");try{p.onreadystatechange=g}catch{}}}function Iy(l){l.I&&(a.clearTimeout(l.I),l.I=null)}t.isActive=function(){return!!this.g};function Kn(l){return l.g?l.g.readyState:0}t.Z=function(){try{return 2<Kn(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(l){if(this.g){var d=this.g.responseText;return l&&d.indexOf(l)==0&&(d=d.substring(l.length)),P1(d)}};function Sy(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function J1(l){const d={};l=(l.g&&2<=Kn(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<l.length;g++){if(E(l[g]))continue;var p=T(l[g]);const O=p[0];if(p=p[1],typeof p!="string")continue;p=p.trim();const b=d[O]||[];d[O]=b,b.push(p)}C(d,function(g){return g.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function jo(l,d,p){return p&&p.internalChannelParams&&p.internalChannelParams[l]||d}function Cy(l){this.Aa=0,this.i=[],this.j=new Do,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=jo("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=jo("baseRetryDelayMs",5e3,l),this.cb=jo("retryDelaySeedMs",1e4,l),this.Wa=jo("forwardChannelMaxRetries",2,l),this.wa=jo("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new oy(l&&l.concurrentRequestLimit),this.Da=new G1,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=Cy.prototype,t.la=8,t.G=1,t.connect=function(l,d,p,g){St(0),this.W=l,this.H=d||{},p&&g!==void 0&&(this.H.OSID=p,this.H.OAID=g),this.F=this.X,this.I=by(this,null,this.W),Xl(this)};function _d(l){if(Ry(l),l.G==3){var d=l.U++,p=qn(l.I);if(ve(p,"SID",l.K),ve(p,"RID",d),ve(p,"TYPE","terminate"),Bo(l,p),d=new vr(l,l.j,d),d.L=2,d.v=Kl(qn(p)),p=!1,a.navigator&&a.navigator.sendBeacon)try{p=a.navigator.sendBeacon(d.v.toString(),"")}catch{}!p&&a.Image&&(new Image().src=d.v,p=!0),p||(d.g=Ly(d.j,null),d.g.ea(d.v)),d.F=Date.now(),Wl(d)}Oy(l)}function Yl(l){l.g&&(vd(l),l.g.cancel(),l.g=null)}function Ry(l){Yl(l),l.u&&(a.clearTimeout(l.u),l.u=null),Jl(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&a.clearTimeout(l.s),l.s=null)}function Xl(l){if(!ay(l.h)&&!l.s){l.s=!0;var d=l.Ga;Bn||Z(),$||(Bn(),$=!0),Y.add(d,l),l.B=0}}function Z1(l,d){return ly(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=d.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=xo(m(l.Ga,l,d),Dy(l,l.B)),l.B++,!0)}t.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const O=new vr(this,this.j,l);let b=this.o;if(this.S&&(b?(b=_(b),k(b,this.S)):b=this.S),this.m!==null||this.O||(O.H=b,b=null),this.P)e:{for(var d=0,p=0;p<this.i.length;p++){t:{var g=this.i[p];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(d+=g,4096<d){d=p;break e}if(d===4096||p===this.i.length-1){d=p+1;break e}}d=1e3}else d=1e3;d=ky(this,O,d),p=qn(this.I),ve(p,"RID",l),ve(p,"CVER",22),this.D&&ve(p,"X-HTTP-Session-Id",this.D),Bo(this,p),b&&(this.O?d="headers="+encodeURIComponent(String(vy(b)))+"&"+d:this.m&&gd(p,this.m,b)),md(this.h,O),this.Ua&&ve(p,"TYPE","init"),this.P?(ve(p,"$req",d),ve(p,"SID","null"),O.T=!0,hd(O,p,null)):hd(O,p,d),this.G=2}}else this.G==3&&(l?Ay(this,l):this.i.length==0||ay(this.h)||Ay(this))};function Ay(l,d){var p;d?p=d.l:p=l.U++;const g=qn(l.I);ve(g,"SID",l.K),ve(g,"RID",p),ve(g,"AID",l.T),Bo(l,g),l.m&&l.o&&gd(g,l.m,l.o),p=new vr(l,l.j,p,l.B+1),l.m===null&&(p.H=l.o),d&&(l.i=d.D.concat(l.i)),d=ky(l,p,1e3),p.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),md(l.h,p),hd(p,g,d)}function Bo(l,d){l.H&&U(l.H,function(p,g){ve(d,g,p)}),l.l&&hy({},function(p,g){ve(d,g,p)})}function ky(l,d,p){p=Math.min(l.i.length,p);var g=l.l?m(l.l.Na,l.l,l):null;e:{var O=l.i;let b=-1;for(;;){const B=["count="+p];b==-1?0<p?(b=O[0].g,B.push("ofs="+b)):b=0:B.push("ofs="+b);let pe=!0;for(let Ze=0;Ze<p;Ze++){let le=O[Ze].g;const ct=O[Ze].map;if(le-=b,0>le)b=Math.max(0,O[Ze].g-100),pe=!1;else try{Q1(ct,B,"req"+le+"_")}catch{g&&g(ct)}}if(pe){g=B.join("&");break e}}}return l=l.i.splice(0,p),d.D=l,g}function Py(l){if(!l.g&&!l.u){l.Y=1;var d=l.Fa;Bn||Z(),$||(Bn(),$=!0),Y.add(d,l),l.v=0}}function yd(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=xo(m(l.Fa,l),Dy(l,l.v)),l.v++,!0)}t.Fa=function(){if(this.u=null,Ny(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=xo(m(this.ab,this),l)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,St(10),Yl(this),Ny(this))};function vd(l){l.A!=null&&(a.clearTimeout(l.A),l.A=null)}function Ny(l){l.g=new vr(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var d=qn(l.qa);ve(d,"RID","rpc"),ve(d,"SID",l.K),ve(d,"AID",l.T),ve(d,"CI",l.F?"0":"1"),!l.F&&l.ja&&ve(d,"TO",l.ja),ve(d,"TYPE","xmlhttp"),Bo(l,d),l.m&&l.o&&gd(d,l.m,l.o),l.L&&(l.g.I=l.L);var p=l.g;l=l.ia,p.L=1,p.v=Kl(qn(d)),p.m=null,p.P=!0,ry(p,l)}t.Za=function(){this.C!=null&&(this.C=null,Yl(this),yd(this),St(19))};function Jl(l){l.C!=null&&(a.clearTimeout(l.C),l.C=null)}function xy(l,d){var p=null;if(l.g==d){Jl(l),vd(l),l.g=null;var g=2}else if(pd(l.h,d))p=d.D,uy(l.h,d),g=1;else return;if(l.G!=0){if(d.o)if(g==1){p=d.m?d.m.length:0,d=Date.now()-d.F;var O=l.B;g=Bl(),It(g,new Z_(g,p)),Xl(l)}else Py(l);else if(O=d.s,O==3||O==0&&0<d.X||!(g==1&&Z1(l,d)||g==2&&yd(l)))switch(p&&0<p.length&&(d=l.h,d.i=d.i.concat(p)),O){case 1:pi(l,5);break;case 4:pi(l,10);break;case 3:pi(l,6);break;default:pi(l,2)}}}function Dy(l,d){let p=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(p*=2),p*d}function pi(l,d){if(l.j.info("Error code "+d),d==2){var p=m(l.fb,l),g=l.Xa;const O=!g;g=new fi(g||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Hl(g,"https"),Kl(g),O?q1(g.toString(),p):K1(g.toString(),p)}else St(2);l.G=0,l.l&&l.l.sa(d),Oy(l),Ry(l)}t.fb=function(l){l?(this.j.info("Successfully pinged google.com"),St(2)):(this.j.info("Failed to ping google.com"),St(1))};function Oy(l){if(l.G=0,l.ka=[],l.l){const d=cy(l.h);(d.length!=0||l.i.length!=0)&&(N(l.ka,d),N(l.ka,l.i),l.h.i.length=0,P(l.i),l.i.length=0),l.l.ra()}}function by(l,d,p){var g=p instanceof fi?qn(p):new fi(p);if(g.g!="")d&&(g.g=d+"."+g.g),ql(g,g.s);else{var O=a.location;g=O.protocol,d=d?d+"."+O.hostname:O.hostname,O=+O.port;var b=new fi(null);g&&Hl(b,g),d&&(b.g=d),O&&ql(b,O),p&&(b.l=p),g=b}return p=l.D,d=l.ya,p&&d&&ve(g,p,d),ve(g,"VER",l.la),Bo(l,g),g}function Ly(l,d,p){if(d&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return d=l.Ca&&!l.pa?new xe(new Vo({eb:p})):new xe(l.pa),d.Ha(l.J),d}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function My(){}t=My.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Zl(){}Zl.prototype.g=function(l,d){return new Ft(l,d)};function Ft(l,d){ut.call(this),this.g=new Cy(d),this.l=l,this.h=d&&d.messageUrlParams||null,l=d&&d.messageHeaders||null,d&&d.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=d&&d.initMessageHeaders||null,d&&d.messageContentType&&(l?l["X-WebChannel-Content-Type"]=d.messageContentType:l={"X-WebChannel-Content-Type":d.messageContentType}),d&&d.va&&(l?l["X-WebChannel-Client-Profile"]=d.va:l={"X-WebChannel-Client-Profile":d.va}),this.g.S=l,(l=d&&d.Sb)&&!E(l)&&(this.g.m=l),this.v=d&&d.supportsCrossDomainXhr||!1,this.u=d&&d.sendRawJson||!1,(d=d&&d.httpSessionIdParam)&&!E(d)&&(this.g.D=d,l=this.h,l!==null&&d in l&&(l=this.h,d in l&&delete l[d])),this.j=new as(this)}v(Ft,ut),Ft.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Ft.prototype.close=function(){_d(this.g)},Ft.prototype.o=function(l){var d=this.g;if(typeof l=="string"){var p={};p.__data__=l,l=p}else this.u&&(p={},p.__data__=sd(l),l=p);d.i.push(new M1(d.Ya++,l)),d.G==3&&Xl(d)},Ft.prototype.N=function(){this.g.l=null,delete this.j,_d(this.g),delete this.g,Ft.aa.N.call(this)};function Vy(l){ad.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var d=l.__sm__;if(d){e:{for(const p in d){l=p;break e}l=void 0}(this.i=l)&&(l=this.i,d=d!==null&&l in d?d[l]:void 0),this.data=d}else this.data=l}v(Vy,ad);function Uy(){ld.call(this),this.status=1}v(Uy,ld);function as(l){this.g=l}v(as,My),as.prototype.ua=function(){It(this.g,"a")},as.prototype.ta=function(l){It(this.g,new Vy(l))},as.prototype.sa=function(l){It(this.g,new Uy)},as.prototype.ra=function(){It(this.g,"b")},Zl.prototype.createWebChannel=Zl.prototype.g,Ft.prototype.send=Ft.prototype.o,Ft.prototype.open=Ft.prototype.m,Ft.prototype.close=Ft.prototype.close,yC=function(){return new Zl},_C=function(){return Bl()},gC=hi,Mp={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},zl.NO_ERROR=0,zl.TIMEOUT=8,zl.HTTP_ERROR=6,Gu=zl,ey.COMPLETE="complete",mC=ey,Q_.EventType=Po,Po.OPEN="a",Po.CLOSE="b",Po.ERROR="c",Po.MESSAGE="d",ut.prototype.listen=ut.prototype.K,ua=Q_,pC=Vo,xe.prototype.listenOnce=xe.prototype.L,xe.prototype.getLastError=xe.prototype.Ka,xe.prototype.getLastErrorCode=xe.prototype.Ba,xe.prototype.getStatus=xe.prototype.Z,xe.prototype.getResponseJson=xe.prototype.Oa,xe.prototype.getResponseText=xe.prototype.oa,xe.prototype.send=xe.prototype.ea,xe.prototype.setWithCredentials=xe.prototype.Ha,fC=xe}).apply(typeof wu<"u"?wu:typeof self<"u"?self:typeof window<"u"?window:{});const Hw="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=Wt.makeFromUrl(e,n)}catch{return new Wt(e,"")}if(r.path==="")return r;throw VU(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(D){D.path.charAt(D.path.length-1)==="/"&&(D.path_=D.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),u={bucket:1,path:3};function c(D){D.path_=decodeURIComponent(D.path)}const h="v[A-Za-z0-9_]+",f=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",y=new RegExp(`^https?://${f}/${h}/b/${i}/o${m}`,"i"),v={bucket:1,path:3},P=n===LR?"(?:storage.googleapis.com|storage.cloud.google.com)":n,N="([^?#]*)",I=new RegExp(`^https?://${P}/${i}/${N}`,"i"),S=[{regex:a,indices:u,postModify:s},{regex:y,indices:v,postModify:c},{regex:I,indices:{bucket:1,path:2},postModify:c}];for(let D=0;D<S.length;D++){const M=S[D],U=M.regex.exec(e);if(U){const C=U[M.indices.bucket];let _=U[M.indices.path];_||(_=""),r=new Wt(C,_),M.postModify(r);break}}if(r==null)throw MU(e);return r}}class $U{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WU(t,e,n){let r=1,i=null,s=null,o=!1,a=0;function u(){return a===2}let c=!1;function h(...N){c||(c=!0,e.apply(null,N))}function f(N){i=setTimeout(()=>{i=null,t(y,u())},N)}function m(){s&&clearTimeout(s)}function y(N,...I){if(c){m();return}if(N){m(),h.call(null,N,...I);return}if(u()||o){m(),h.call(null,N,...I);return}r<64&&(r*=2);let S;a===1?(a=2,S=0):S=(r+Math.random())*1e3,f(S)}let v=!1;function P(N){v||(v=!0,m(),!c&&(i!==null?(N||(a=2),clearTimeout(i),f(0)):N||(a=1)))}return f(0),s=setTimeout(()=>{o=!0,P(!0)},n),P}function HU(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
